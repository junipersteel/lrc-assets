# 1 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c"
...
# 1 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
...
# 2 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
...
# 3 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
...
# 4 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
...
Action()
{
	...
	lr_end_transaction("trx_Speakers",2);
	...
	lr_end_transaction("trx_Speakers_Buy_Now",2);

	lr_start_transaction("trx_Tablets");

	lr_end_transaction("trx_Tablets",2);

	lr_start_transaction("trx_Mice");

	lr_end_transaction("trx_Mice",2);

	return 0;
}
# 5 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
...
# 6 "c:\\demo\\lrc-assets\\lrc-aos-001\\\\combined_LRC-AOS-001.c" 2
